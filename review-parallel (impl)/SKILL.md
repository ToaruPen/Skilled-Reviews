...
description: "Creates parallel code review fragments across focused facets (correctness, security, performance, tests, design) without making code changes. Use for higher-risk or complex changes, especially as review-cycle step 7-1 or when the user asks for parallelized codex exec reviews."
---
