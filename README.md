...
- `MODEL` / `REASONING_EFFORT`: defaults are set per script (e.g. `review-parallel`: `MODEL=gpt-5.2-codex`, `REASONING_EFFORT=high`; `pr-review`: `MODEL=gpt-5.2`, `REASONING_EFFORT=xhigh`). Override them to your preferred model/effort.
